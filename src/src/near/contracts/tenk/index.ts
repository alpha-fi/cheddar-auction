...
export class TenkContract {
  ...
  async create_linkdrop(
    ...
    return providers.getTransactionLastResult(
      await this.create_linkdropRaw(args, options)
    );
  }
  /**
   * Create a pending token that can be claimed with corresponding private key
  ...
  async transfer_ownership(
    ...
    return providers.getTransactionLastResult(
      await this.transfer_ownershipRaw(args, options)
    );
  }
  /**
   * @allow ["::admins", "::owner"]
   */
  transfer_ownershipRaw(
    args: {
      new_owner: AccountId;
    },
    options?: ChangeMethodOptions
   ...
   * @allow ["::admins", "::owner"]
   */
  async update_initial_royalties(
    args: {
      initial_royalties: Royalties;
    },
    options?: ChangeMethodOptions
    ...
    return providers.getTransactionLastResult(
      await this.update_initial_royaltiesRaw(args, options)
    );
  }
  /**
   * @allow ["::admins", "::owner"]
   */
  update_initial_royaltiesRaw(
    args: {
      initial_royalties: Royalties;
    },
    options?: ChangeMethodOptions
    ...
    return this.account.functionCall({
      contractId: this.contractId,
      methodName: "update_initial_royalties",
      args,
      ...options,
    });
  }
  ...
  async update_royalties(
    ...
    return providers.getTransactionLastResult(
      await this.update_royaltiesRaw(args, options)
    );
  }
  /**
   * @allow ["::admins", "::owner"]
  ...
  async update_allowance(
    ...
    return providers.getTransactionLastResult(
      await this.update_allowanceRaw(args, options)
    );
  }
  /**
   * @allow ["::admins", "::owner"]
  ...
  async update_uri(
    ...
    return providers.getTransactionLastResult(
      await this.update_uriRaw(args, options)
    );
  }
  /**
   * @allow ["::admins", "::owner"]
  ...
  async add_whitelist_accounts(
    ...
    return providers.getTransactionLastResult(
      await this.add_whitelist_accountsRaw(args, options)
    );
  }
  /**
   * @allow ["::admins", "::owner"]
   */
  add_whitelist_accountsRaw(
    args: {
      accounts: AccountId[];
      allowance?: u32;
    },
   ...
   * @allow ["::admins", "::owner"]
   */
  async update_whitelist_accounts(
    args: {
      accounts: AccountId[];
    ...
    return providers.getTransactionLastResult(
      await this.update_whitelist_accountsRaw(args, options)
    );
  }
  /**
   * @allow ["::admins", "::owner"]
   */
  update_whitelist_accountsRaw(
    args: {
      accounts: AccountId[];
      allowance_increase: u32;
    },
    ...
    return this.account.functionCall({
      contractId: this.contractId,
      methodName: "update_whitelist_accounts",
      args,
      ...options,
    });
  }
  ...
  async close_sale(args = {}, options?: ChangeMethodOptions): Promise<boolean> {
    return providers.getTransactionLastResult(
      await this.close_saleRaw(args, options)
    );
  }
  /**
   * End public sale/minting, going back to the pre-presale state in which no one can mint.
  ...
  async start_presale(
    ...
    return providers.getTransactionLastResult(
      await this.start_presaleRaw(args, options)
    );
  }
  /**
   * Override the current presale start time to start presale now.
  ...
  async start_sale(
    ...
    return providers.getTransactionLastResult(
      await this.start_saleRaw(args, options)
    );
  }
  /**
   * @allow ["::admins", "::owner"]
  ...
  async add_admin(
    ...
    return providers.getTransactionLastResult(
      await this.add_adminRaw(args, options)
    );
  }
  /**
   * Add a new admin. Careful who you add!
  ...
  async update_price(
    ...
    return providers.getTransactionLastResult(
      await this.update_priceRaw(args, options)
    );
  }
  /**
   * Update public sale price.
  ...
  async update_presale_price(
    ...
    return providers.getTransactionLastResult(
      await this.update_presale_priceRaw(args, options)
    );
  }
  /**
   * Update the presale price
  ...
  update_presale_priceRaw(
    ...
    return this.account.functionCall({
      contractId: this.contractId,
      methodName: "update_presale_price",
      args,
      ...options,
    });
  }
  ...
  async nft_transfer_payout(
    ...
    return providers.getTransactionLastResult(
      await this.nft_transfer_payoutRaw(args, options)
    );
  }
  nft_transfer_payoutRaw(
    args: {
      receiver_id: AccountId;
      token_id: string;
      approval_id?: u64;
  ...
  async nft_mint_one(args = {}, options?: ChangeMethodOptions): Promise<Token> {
    return providers.getTransactionLastResult(
      await this.nft_mint_oneRaw(args, options)
    );
  }
  nft_mint_oneRaw(
    args = {},
  ...
  async nft_mint_many(
    ...
    return providers.getTransactionLastResult(
      await this.nft_mint_manyRaw(args, options)
    );
  }
  nft_mint_manyRaw(
    args: {
