...
describe('deploy contract ' + contractName, () => {
	...
	const token_type1 = "near";
	const token_type2 = fungibleId;
	...
	// test('bob place bid for nft with NEAR', async () => {
	// 	const token_id = tokenIds[0];
